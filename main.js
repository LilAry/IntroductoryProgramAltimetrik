...
const key = 'a9201915ea2b446f99b5f204238fccb8';
//define a variable to store the number of pages
let n = 1;
//create an observer
...
const showPlatforms = platforms =>{
    ...
    platforms.forEach((item)=> {
        switch (item.platform.name) {
            case "PC": 
            platformstoShow+= `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                break;
            case "PlayStation": 
            platformstoShow+= `<svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const setGameHTML = (game) => {
    ...
    div.className = 'item';
    div.innerHTML = `
    <div class="div1" id="modal-btn" onclick='openModal(${game.id})'>
                <div class="div4-image">
                    <img src="${game.background_image}" width='363px' height='190.51px' > 
                </div> 
                <div class="card-body">
